/** GLSL 노이즈 라이브러리 (셰이더 문자열)
 *  - snoise: Ashima Arts 3D simplex noise (public domain)
 *  - curl:   컬 노이즈 — 발산 없는 유체 흐름장
 *  - fbm:    2D value-noise 기반 fractal brownian motion (연기용)
 */
