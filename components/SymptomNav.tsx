    ...
    <div className="flex flex-wrap gap-2.5">
      {symptoms.map((s) => (
        <Link
          key={s.href + s.text}
          href={s.href}
          className="group rounded-full border border-mist/15 bg-white/[0.03] px-5 py-2.5 text-[13px] text-mist/65 transition-all hover:border-rose/50 hover:bg-rose/5 hover:text-rose md:text-sm"
        >
          {s.text}
          <span
            aria-hidden
